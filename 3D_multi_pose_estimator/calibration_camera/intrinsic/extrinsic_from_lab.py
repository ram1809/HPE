...
#     cap.set(cv2.CAP_PROP_FOCUS, 100)  # Set the focus level (try values between 0-255)
#     cap.set(cv2.CAP_PROP_EXPOSURE, -6)  # Set exposure level (-4 might help reduce blur in bright conditions)
