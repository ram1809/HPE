...
# Set input files
# train_paths = ["panoptic_dataset/train1.json", "panoptic_dataset/train2.json", "panoptic_dataset/train3.json", "panoptic_dataset/train4.json",
#              "panoptic_dataset/train5.json", "panoptic_dataset/train6.json", "panoptic_dataset/train7.json", "panoptic_dataset/train8.json",
#              "panoptic_dataset/train9.json", "panoptic_dataset/train10.json"]
# dev_paths = ["panoptic_dataset/dev1.json", "panoptic_dataset/dev2.json", "panoptic_dataset/dev3.json", "panoptic_dataset/dev4.json"]
# test_paths = ["panoptic_dataset/dev1.json", "panoptic_dataset/dev2.json", "panoptic_dataset/dev3.json", "panoptic_dataset/dev4.json"]

train_paths = [f.strip() for f in open(sys.argv[1], 'r')]
dev_paths = [f.strip() for f in open(sys.argv[2], 'r')]
test_paths = [f for f in open(sys.argv[3], 'r')]
